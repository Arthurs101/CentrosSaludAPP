...
const addCirujia = 'INSERT INTO public."cirugía" (no_colegiado_medico_encargado,id_paciente,fecha_inicio,estado,fecha_finalizada,id_centro_salud) VALUES ($1,$2,$3,$4,$5,$6)'
const addCirujiaEv= 'INSERT INTO public."evolucion_cirugía" ("cirujía_id","observación",fecha) VALUES ($1,$2,$3)'
...
FROM public."cirugía" a INNER JOIN public."médico" b on "número_de_colegiado" = no_colegiado_medico_encargado
INNER JOIN public.personal c ON c.id = b.id_personal 
...
const getCirujiaEv = 'SELECT * FROM public."evolucion_cirugía" WHERE "cirujía_id" = $1'
const updateTratamiento = 'UPDATE tratamiento set estado = $1 WHERE id = $2'
const updateCirujiaDetails = 'UPDATE public."cirugía" SET estado = $1 ,fecha_finalizada = $2 WHERE id = $3'
